            ...
            <div class="footerMiddleSection">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <h2 class="FCopyRight">© <?php echo strtr(date('Y'), ['0'=>'০','1'=>'১','2'=>'২','3'=>'৩','4'=>'৪','5'=>'৫','6'=>'৬','7'=>'৭','8'=>'৮','9'=>'৯']); ?> <a href="<?php echo esc_url( home_url('/') ); ?>"><?php echo esc_html(get_theme_mod('site_title_bn')); ?></a> কর্তৃক সর্বসত্ব ® সংরক্ষিত</h2>
